...
* **本サービスの動画配信やスクリーンショット共有とともに**、下記の内容を外部に共有する行為は禁止です。
...
* OFFスーパー
  - プレイ中に音が鳴らない設定です。また、パズル開始前以外のタイミングで、サウンド設定の変更（ONへの切り替え）ができなくなります。
...
画面右上のシェアボタンからはURL、クリア後のシェアボタンからは記録をシェアできます。ただし、本サービスでは画像をシェアする機能を提供しておりません。<br>ご利用の際は、先に利用規約を必ずご確認ください。
